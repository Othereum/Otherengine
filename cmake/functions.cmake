...
function(oe_download_package name)
    configure_file("${PROJECT_SOURCE_DIR}/cmake/deps/${name}.cmake" "${name}-download/CMakeLists.txt" @ONLY)
	...
	if(EXISTS "${PROJECT_SOURCE_DIR}/cmake/deps/${name}-build.cmake")
		configure_file("${PROJECT_SOURCE_DIR}/cmake/deps/${name}-build.cmake" "${name}-src/CMakeLists.txt" @ONLY)
	endif()
