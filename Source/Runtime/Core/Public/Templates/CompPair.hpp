...
namespace oeng::core
{
	...
	public:
		...
		[[nodiscard]] constexpr T1& first() noexcept { return *this; }
		[[nodiscard]] constexpr T2& second() noexcept { return second_; }
		[[nodiscard]] constexpr const T1& first() const noexcept { return *this; }
		[[nodiscard]] constexpr const T2& second() const noexcept { return second_; }
	...
	public:
		...
		[[nodiscard]] constexpr T1& first() noexcept { return first_; }
		[[nodiscard]] constexpr T2& second() noexcept { return second_; }
		[[nodiscard]] constexpr const T1& first() const noexcept { return first_; }
		[[nodiscard]] constexpr const T2& second() const noexcept { return second_; }
